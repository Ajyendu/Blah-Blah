    ...
    return (
      <div className="profile-page-shell app-shell h-screen w-screen flex">
        <div className="app-card flex flex-1 m-6 overflow-hidden">
          ...
          <div className="app-content-wrap app-card__main flex-1 flex min-w-0 items-center justify-center">
  ...
  return (
    <div className="profile-page-shell app-shell h-screen w-screen flex">
      <div className="app-card flex flex-1 m-6 overflow-hidden">
        ...
        <div className="app-content-wrap app-card__main flex-1 flex min-w-0 flex-col profile-content-wrap">
          ...
          {authUser?.userCode && (
            <div className="profile-user-id">
              ...
              <div className="profile-user-id__row">
                <code className="profile-user-id__code">
                  {authUser.userCode}
                </code>
                <button
                  type="button"
